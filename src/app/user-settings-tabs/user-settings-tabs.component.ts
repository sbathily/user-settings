...
@Component({
  selector: 'app-user-settings-tabs',
  templateUrl: './user-settings-tabs.component.html',
  styleUrls: ['./user-settings-tabs.component.scss']
})
export class UserSettingsTabsComponent implements OnInit {
